...
# V129 bias bake for 1-layer skip worked (PCOC=1.07), V122 for 2-layer skip (PCOC=1.08)
# V129 is riskier for 3-layer skip but worth trying for ~32s latency
V129_SKIP_LAYERS = os.environ.get("GRAB_V129_SKIP_LAYERS", "3,4,5")
V129_LOGIT_BIAS = float(os.environ.get("GRAB_V129_LOGIT_BIAS", str(math.log(0.5269))))
