...
V112_SORTED_TOP2 = os.environ.get("GRAB_V112_SORTED_TOP2", "1").lower() not in {"0", "false", "no"}
V112_OFFSETS_STAY_CPU = os.environ.get("GRAB_V112_OFFSETS_STAY_CPU", "1").lower() not in {"0", "false", "no"}
