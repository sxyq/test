...
V107_REDUCE_EMPTY_CACHE = os.environ.get("GRAB_V107_REDUCE_EMPTY_CACHE", "1").lower() not in {"0", "false", "no"}
    ...
    with torch.inference_mode(), autocast_ctx:
        if shard_files:
            ...
            for sf in shard_files:
                ...
                del shard_batches
                shard_idx += 1
                if use_cuda and (not V107_REDUCE_EMPTY_CACHE or shard_idx % 3 == 0):
