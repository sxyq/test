...
V130_COMPILE_MODE = os.environ.get("GRAB_V130_COMPILE_MODE", "max-autotune")
...
def main():
    ...
    # V130: compile seq_encoder + rep_encoder after dtype conversion.
    # V179: Also compile rep_encoder (V169 only compiled seq_encoder).
    # Output head stays eager (small linear, not worth compile overhead).
