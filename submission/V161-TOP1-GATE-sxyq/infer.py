...
V161_TOP1_GATE = os.environ.get("GRAB_V161_TOP1_GATE", "1").lower() not in {"0", "false", "no"}
...
class SMoE(nn.Module):
    ...
    def forward(self, x):
        ...
        # V161: Top-1 routing at inference — halve expert compute
        if V161_TOP1_GATE and not self.training:
            topk_idx = topk_idx[:, :, :1]   # [B,S,1]
            topk_score = topk_score[:, :, :1]  # [B,S,1]
