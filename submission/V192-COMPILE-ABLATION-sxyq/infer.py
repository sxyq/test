...
# V192: compile ablation candidate. Default OFF to test whether V185
# compile/warmup overhead is a negative contributor on the official workload.
# Users can still override with GRAB_V130_COMPILE=1.
V130_TORCH_COMPILE_ENABLED = os.environ.get("GRAB_V130_COMPILE", "0").lower() not in {"0", "false", "no"}
V130_COMPILE_MODE = os.environ.get("GRAB_V130_COMPILE_MODE", "default")
V179_COMPILE_REP_ENCODER = os.environ.get("GRAB_V179_COMPILE_REP_ENCODER", "0").lower() not in {"0", "false", "no"}
